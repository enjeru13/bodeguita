                            ...
                            <div className="flex gap-2">
                                {COLORS.map((color) => (
                                    <button
                                        ...
                                        className={`h-6 w-6 rounded-full border-2 transition-transform hover:scale-110 ${color.bg} ${
                                            data.color === color.id ? 'border-zinc-900 dark:border-white' : 'border-transparent'
                                        }`}
                                    />
                                ))}
                            </div>
                            <Button disabled={processing} type="submit" size="sm" className="font-black uppercase tracking-widest">
                                Guardar Nota
                            </Button>
                        </div>
                    </form>
